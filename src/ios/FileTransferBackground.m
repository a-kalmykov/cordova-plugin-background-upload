...
- (void)startUpload:(CDVInvokedUrlCommand*)command
{
    ...
    NSString* mimeType  = payload[@"mimeType"];
    ...
    NSData *body = [self createBodyWithBoundary:boundary parameters:parameters paths:@[filePath] fieldName:payload[@"fileKey"] mimeType:mimeType];
